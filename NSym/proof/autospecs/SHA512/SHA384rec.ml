...
let cry_processBlocks_rec : Cryptol.cryExp -> Cryptol.cryExp -> Cryptol.cryExp -> Cryptol.cryExp =
  ...
  lowercase_num
  lowercase_data = (Cryptol.toCry1Dim (Cryptol.apply_rec "spec.SHA384rec.air_processBlocks_rec" [(Cryptol.toAir lowercase_H);
...
let air_processBlocks_rec =
  (Cryptol.defun_rec "spec.SHA384rec.air_processBlocks_rec" [(Cryptol.sb "lowercase_H" 512);
