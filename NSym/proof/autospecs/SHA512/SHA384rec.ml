...
let lowercase_H0 : Cryptol.cryExp = (Cryptol.CrySeq
  [(((Cryptol.number "0xcbbb9d5dc1059ed8") (Cryptol.seq "0x40" Cryptol.Bit)));
   (((Cryptol.number "0x629a292a367cd507") (Cryptol.seq "0x40" Cryptol.Bit)));
   (((Cryptol.number "0x9159015a3070dd17") (Cryptol.seq "0x40" Cryptol.Bit)));
   (((Cryptol.number "0x152fecd8f70e5939") (Cryptol.seq "0x40" Cryptol.Bit)));
   (((Cryptol.number "0x67332667ffc00b31") (Cryptol.seq "0x40" Cryptol.Bit)));
   (((Cryptol.number "0x8eb44a8768581511") (Cryptol.seq "0x40" Cryptol.Bit)));
   (((Cryptol.number "0xdb0c2e0d64f98fa7") (Cryptol.seq "0x40" Cryptol.Bit)));
   (((Cryptol.number "0x47b5481dbefa4fa4") (Cryptol.seq "0x40" Cryptol.Bit)))])
...
let air_S0 =
  (Cryptol.defun "spec.SHA384rec.air_S0" [(Cryptol.sb "lowercase_x" 64)]  (Cryptol.toAir (cry_S0 (Cryptol.toCry1Dim (Cryptol.sb "lowercase_x" 64)))))
...
let air_S1 =
  (Cryptol.defun "spec.SHA384rec.air_S1" [(Cryptol.sb "lowercase_x" 64)]  (Cryptol.toAir (cry_S1 (Cryptol.toCry1Dim (Cryptol.sb "lowercase_x" 64)))))
...
let air_Ch =
  (Cryptol.defun "spec.SHA384rec.air_Ch" [(Cryptol.sb "lowercase_x" 64);
...
let air_Maj =
  (Cryptol.defun "spec.SHA384rec.air_Maj" [(Cryptol.sb "lowercase_x" 64);
  (Cryptol.sb "lowercase_y" 64);
...
let air_messageSchedule_Word =
  (Cryptol.defun "spec.SHA384rec.air_messageSchedule_Word" [(Cryptol.sb "lowercase_w1" 64);
...
let air_compress_Common_t1 =
  (Cryptol.defun "spec.SHA384rec.air_compress_Common_t1" [(Cryptol.sb "lowercase_e" 64);
...
let air_compress_Common_t2 =
  (Cryptol.defun "spec.SHA384rec.air_compress_Common_t2" [(Cryptol.sb "lowercase_a" 64);
...
let air_compress_Common_e =
  (Cryptol.defun "spec.SHA384rec.air_compress_Common_e" [(Cryptol.sb "lowercase_d" 64);
...
let air_compress_Common_a =
  (Cryptol.defun "spec.SHA384rec.air_compress_Common_a" [(Cryptol.sb "lowercase_T1" 64);
...
let air_processBlock_Common_rec =
  (Cryptol.defun "spec.SHA384rec.air_processBlock_Common_rec" [(Cryptol.sb "lowercase_H" 512);
...
let cry_processBlocks_rec : Cryptol.cryExp -> Cryptol.cryExp -> Cryptol.cryExp =
  ...
  lowercase_data = (Cryptol.toCry1Dim (Cryptol.apply_rec "spec.SHA384rec.air_processBlocks_rec" [(Cryptol.toAir lowercase_num);
...
let air_processBlocks_rec =
  (Cryptol.defun_rec "spec.SHA384rec.air_processBlocks_rec" [(Cryptol.sb "lowercase_num" 64);
